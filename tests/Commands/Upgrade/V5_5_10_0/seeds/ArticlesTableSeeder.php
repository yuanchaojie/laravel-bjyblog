...
如果还没下定决定要使用laravel；
那么我上来就是一个连接；
[关于 thinkphp 和 laravel 框架的选择](http://deatrabbit.top/article/109)
不是别人说好我也跟着说好的；
而是我实实在在的使用过后；
不断的发现 laravel 的优雅；
真心喜欢；才这么推荐的；
...
我一直在用的；
也比较喜欢的`免费`翻墙软件；
[推荐开发工具系列之 -- 翻墙软件 lantern](http://deatrabbit.top/article/107)
